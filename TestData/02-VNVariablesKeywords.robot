...
${VN_header_categories_baby_gear_link}  //div[@id='menu']//a[@href='https://iprice.vn/san-pham-tam-cham-soc-co-the/']//span[text()='Sản phẩm tắm & chăm sóc cơ thể']
${VN_header_categories_bath_body_link}  //div[@id='menu']//a[@href='https://iprice.vn/san-pham-vat-dung-cho-be/']//span[text()='Sản phẩm vật dụng cho bé']
...
iPrice VN Homepage Categories Landing
    ...
    Wait Until Page Contains Element  ${VN_header_categories_appliances_link}
