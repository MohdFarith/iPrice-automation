...
iPrice PH Homepage Categories Landing
    ...
    Wait Until Page Contains Element  ${PH_header_categories_appliances_link}
    Element Should Not Be Visible  ${PH_header_categories_appliances_link}
    Wait Until Page Contains Element  ${PH_header_categories_automotive_link}
    ...
    Wait Until Page Contains Element  ${PH_header_categories_groceries_link}
    Element Should Not Be Visible  ${PH_header_categories_groceries_link}
