...
${VN_header_categories_+_categories_link}  //div[@id='menu']//a[contains(@href,'https://iprice.vn/categories/') and text()='+ Danh mục']
...
${VN_coupon_see_all_store_link}  //div[@id='coupon-overview']//a[text()='Hiển thị tất cả cửa hàng >']
${VN_coupon_stores_title}  Cửa hàng | iprice Việt Nam
