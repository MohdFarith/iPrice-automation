*** Settings ***
Documentation    This file will only store keywords for TH.
...
iPrice TH Header Section Validation
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_logo}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_logo_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_search_input}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_search_icon}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_popular_searches_text}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_coupon_logo_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_coupon_text}
    ...
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_categories_clothing_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_categories_shoes_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_categories_bags_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_categories_watches_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_categories_jewellery_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_categories_computing_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_categories_phones_tablets_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_categories_gaming_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_categories_camera_photo_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_categories_tv_video_dvd_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_categories_appliances_link}
    Run Keyword And Continue On Failure  Element Should Not Be Visible  ${TH_header_categories_automotive_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${TH_header_categories_+_categories_link}
...
iPrice TH Homepage Categories Landing
    ...
    Wait Until Page Contains Element  ${TH_header_categories_groceries_link}
    Element Should Not Be Visible  ${TH_header_categories_groceries_link}
...
iPrice TH Do A Search In Header  [Arguments]  ${itemNames}
...
iPrice TH Coupons Access All Store
    Mouse Over  ${TH_coupon_see_all_store_link}
    Click Element  ${TH_coupon_see_all_store_link}
    Sleep  1
    Title Should Be  ${TH_coupon_stores_title}

iPrice TH Coupons Store Access A Store  [Arguments]  ${store_name}
    ...
    Wait Until Element Is Visible  //div[@id='coupon-header']//h1[text()='คูปองและส่วนลดจาก Lazada ในประเทศไทย']
