*** Settings ***
Documentation    This file will only store keywords for VN.
...
iPrice VN Header Section Validation
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_logo}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_logo_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_search_input}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_search_icon}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_popular_searches_text}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_coupon_logo_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_coupon_text}
    ...
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_categories_clothing_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_categories_shoes_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_categories_bags_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_categories_watches_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_categories_jewellery_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_categories_computing_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_categories_phones_tablets_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_categories_gaming_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_categories_camera_photo_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_categories_tv_video_dvd_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_categories_appliances_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_categories_automotive_link}
    Run Keyword And Continue On Failure  Element Should Be Visible  ${VN_header_categories_+_categories_link}
...
iPrice VN Do A Search In Header  [Arguments]  ${itemNames}
...
iPrice VN Coupons Page Landing
    ...
    Wait Until Element Is Visible  //div[@id='content']//h1[text()="Mã giảm giá, voucher và khuyến mãi mới nhất ${year} tại Việt Nam"]

iPrice VN Coupons Access All Store
    Mouse Over  ${VN_coupon_see_all_store_link}
    Click Element  ${VN_coupon_see_all_store_link}
    Sleep  1
    Title Should Be  ${VN_coupon_stores_title}

iPrice VN Coupons Store Access A Store  [Arguments]  ${store_name}
    ...
    Wait Until Element Is Visible  //div[@id='coupon-header']//h1[text()='Lazada Mã coupon và Voucher']
