...
${SG_header_categories_+_categories_link}  //div[@id='menu']//a[contains(@href,'https://iprice.sg/categories/') and text()='+ Categories']
...
${SG_coupon_see_all_store_link}  //div[@id='coupon-overview']//a[text()='See All Stores >']
${SG_coupon_stores_title}  Stores | iprice Singapore
